...
Shader "KriptoFX/RFX1/Decal"
{
	...
	[Toggle(USE_WORLD_SPACE_UV)] _UseWorldSpaceUV("Use World Space UV", Int) = 0
		[Toggle(USE_FRARFX1_BLENDING)] _UseFrameBlending("Use Frame Blending", Int) = 0
...
#pragma shader_feature USE_FRARFX1_BLENDING
...
#define _Cutout_arr Props
	...
	v2f vert(appdata_t v)
	{
		...
		o.color = v.color;
	//	o.color.rgb *= ShadeCustomLights(v.vertex, 1, RFX1_LightCount) * 3;
