...
public class RFX1_EffectSettings : MonoBehaviour
{
    ...
    public bool LimitMaxDistance = true;
    public float MaxDistnace = 30;
    public float Mass = 1;
    public float Speed = 10;
    public float AirDrag = 0.1f;
    public bool UseGravity = true;

    private const string distortionNamePC = "KriptoFX/RFX1/Distortion";
    private const string distortionNameMobile = "KriptoFX/RFX1/DistortionMobile";
    ...
    public void ChangeParticleColor()
    {
        ...
        var hue = RFX1_ColorHelper.ColorToHSV(EffectColor).H;
        RFX1_ColorHelper.ChangeObjectColorByHUE(gameObject, hue);

        //var physxMotion = GetComponentInChildren<RFX1_PhysicsMotion>();
        //if (physxMotion != null) physxMotion.HUE = hue;

        //var rayCastCollision = GetComponentInChildren<RFX1_RaycastCollision>();
        //if (rayCastCollision != null) rayCastCollision.HUE = hue;
    }

    public void SetFlatDecals()
    {
        var decals = GetComponentsInChildren<RFX1_Decal>();
    ...
    public void DisableShadows()
    {
        ...
        {
                var lightCurves = customLight.GetComponent<RFX1_LightCurves>();
        ...
        //var psLights = GetComponentsInChildren<RFX1_ParticleLight>();
