...
#pragma warning restore CS0612
        ...
        protected virtual void BuildUp(GameObject editor)
        {
            ...
            if (eventSystem == null)
            {
                ...
                {
                    RTEStandaloneInputModule standaloneInputModule = editor.AddComponent<RTEStandaloneInputModule>();
                    #if UNITY_ANDROID || UNITY_IOS
                    standaloneInputModule.UseMouse = false;
                    #else
                    standaloneInputModule.UseMouse = true;
                    #endif
                }
            }
        ...
        protected virtual void Start()
        {
            ...
            if (m_eventSystem == null)
            {
                ...
                if (m_eventSystem == null)
                {
                    ...
                    RTEStandaloneInputModule standaloneInputModule = eventSystem.AddComponent<RTEStandaloneInputModule>();
