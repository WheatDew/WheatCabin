...
namespace Battlehub.RTHandles
{
    public static class RTHandlesMenu
    {
        ...
        [MenuItem("Tools/Runtime Handles/Create", priority = 10)]
        ...
        [MenuItem("Tools/Runtime Handles/Enable Editing", priority = 11)]
        ...
        [MenuItem("Tools/Runtime Handles/Disable Editing", priority = 12)]
