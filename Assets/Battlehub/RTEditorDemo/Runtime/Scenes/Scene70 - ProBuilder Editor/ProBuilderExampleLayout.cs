...
{
    /// <summary>
    /// Initializes the runtime editor with a minimal layout (scene and probuilder)
    /// </summary>
    public class ProBuilderExampleLayout : LayoutExtension
    {
        [SerializeField]
        ...
        protected override LayoutInfo GetLayoutInfo(IWindowManager wm)
        {
            ...
            LayoutInfo builder = wm.CreateLayoutInfo("ProBuilder");

            return LayoutInfo.Horizontal(builder, scene, 0.25f);
        }
    }
