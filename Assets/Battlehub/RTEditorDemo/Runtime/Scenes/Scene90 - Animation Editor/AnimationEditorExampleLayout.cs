...
{
    public class AnimationEditorExampleLayout : LayoutExtension
    {
        [SerializeField]
        ...
        protected override LayoutInfo GetLayoutInfo(IWindowManager wm)
        {
            ...
            LayoutInfo animationEditor = wm.CreateLayoutInfo(BuiltInWindowNames.Animation);

            return LayoutInfo.Vertical(
                LayoutInfo.Horizontal(inspector, scene, 0.25f), 
                animationEditor, 
                0.75f);
        }
    }
