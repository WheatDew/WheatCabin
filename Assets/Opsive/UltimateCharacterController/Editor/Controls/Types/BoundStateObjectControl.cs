...
namespace Opsive.UltimateCharacterController.Editor.Controls.Types
{
    ...
    public class BoundStateObjectControlType : StateObjectControlType
    {
        ...
        protected override VisualElement GetControl(TypeControlInput input)
        {
            ...
            FieldInspectorView.AddField(input.UnityObject, input.Target, "m_Bindings", container, (o) => { input.OnChangeEvent(o); }, null, false, null, true, null, input.SerializedProperty.FindPropertyRelative("m_Bindings"));
            FieldInspectorView.AddField(input.UnityObject, input.Target, "m_States", container, (o) => { input.OnChangeEvent(o); }, null, false, null, true, null, input.SerializedProperty.FindPropertyRelative("m_States"));
            return container;
        }
