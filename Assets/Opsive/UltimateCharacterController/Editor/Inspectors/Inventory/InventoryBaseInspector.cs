...
namespace Opsive.UltimateCharacterController.Editor.Inspectors.Inventory
{
    ...
    public class InventoryBaseInspector : InspectorBase
    {
        ...
        public override void OnInspectorGUI()
        {
                ...
                if (itemIdentifiers.Count > 0) {
                    ...
                    for (int i = 0; i < itemIdentifiers.Count; ++i) {
                        ...
                        for (int j = 0; j < inventory.SlotCount; ++j) {
                            var item = inventory.GetActiveCharacterItem(j);
            ...
            EditorGUILayout.PropertyField(PropertyFromName("m_AutoSpawnDestroyRuntimeCharacterItems"));
            EditorGUILayout.PropertyField(PropertyFromName("m_AutoRemoveCharacterItems"));
            EditorGUILayout.PropertyField(PropertyFromName("m_UnequipAllOnDeath"));
