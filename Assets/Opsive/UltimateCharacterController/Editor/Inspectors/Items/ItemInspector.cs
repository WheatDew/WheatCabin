...
namespace Opsive.UltimateCharacterController.Editor.Inspectors.Items
{
    ...
    /// </summary>
    [CustomEditor(typeof(CharacterItem), true)]
    public class ItemInspector : StateBehaviorInspector
    {
        ...
        {
            m_CharacterItem = target as CharacterItem;
        ...
        protected override Action GetDrawCallback()
        {
            ...
            baseCallback += () =>
            {
                ...
                if (itemDefinition == null) {
                    ...
                    var itemSetManager = (target as CharacterItem).GetComponentInParent<ItemSetManager>();
                ...
                if (Application.isPlaying) {
                    ...
                    EditorGUILayout.LabelField("Item Identifier", m_CharacterItem.ItemIdentifier == null ? "(none)" : m_CharacterItem.ItemIdentifier.ToString());
                    EditorGUI.indentLevel--;
                }
                ...
                if (Foldout("Equip")) {
                    ...
                    if (Foldout("Animator Audio", "Equip")) {
                        EditorGUI.indentLevel++;
                        AnimatorAudioStateSetInspector.DrawAnimatorAudioStateSet(m_CharacterItem, m_CharacterItem.EquipAnimatorAudioStateSet, "m_EquipAnimatorAudioStateSet", true,
                ...
                if (Foldout("Unequip")) {
                    ...
                    if (Foldout("Animator Audio", "Unequip")) {
                        EditorGUI.indentLevel++;
                        AnimatorAudioStateSetInspector.DrawAnimatorAudioStateSet(m_CharacterItem, m_CharacterItem.UnequipAnimatorAudioStateSet, "m_UnequipAnimatorAudioStateSet", true,
        ...
        {
            AnimatorAudioStateSetInspector.OnAudioClipDraw(m_ReorderableEquipAnimatorAudioStateSetAudioList, rect, index, m_CharacterItem.EquipAnimatorAudioStateSet.States, SelectedEquipAnimatorAudioStateSetIndexKey, target);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAudioClipListAdd(list, m_CharacterItem.EquipAnimatorAudioStateSet.States, SelectedEquipAnimatorAudioStateSetIndexKey, target);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAudioClipListRemove(list, m_CharacterItem.EquipAnimatorAudioStateSet.States, SelectedEquipAnimatorAudioStateSetIndexKey, target);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAudioClipDraw(m_ReorderableUnequipAnimatorAudioStateSetAudioList, rect, index, m_CharacterItem.UnequipAnimatorAudioStateSet.States, SelectedUnequipAnimatorAudioStateSetIndexKey, target);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAudioClipListAdd(list, m_CharacterItem.UnequipAnimatorAudioStateSet.States, SelectedUnequipAnimatorAudioStateSetIndexKey, target);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAudioClipListRemove(list, m_CharacterItem.UnequipAnimatorAudioStateSet.States, SelectedUnequipAnimatorAudioStateSetIndexKey, target);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAnimatorAudioStateElementDraw(m_ReorderableEquipAnimatorAudioStateSetList, m_CharacterItem.EquipAnimatorAudioStateSet, rect, index, isActive, isFocused, target);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAnimatorAudioStateElementDraw(m_ReorderableUnequipAnimatorAudioStateSetList, m_CharacterItem.UnequipAnimatorAudioStateSet, rect, index, isActive, isFocused, target);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAnimatorAudioStateListAdd(list, m_CharacterItem.EquipAnimatorAudioStateSet, SelectedEquipAnimatorAudioStateSetIndexKey);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAnimatorAudioStateListAdd(list, m_CharacterItem.UnequipAnimatorAudioStateSet, SelectedUnequipAnimatorAudioStateSetIndexKey);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAnimatorAudioStateListRemove(list, m_CharacterItem.EquipAnimatorAudioStateSet, SelectedEquipAnimatorAudioStateSetIndexKey);
        }
        ...
        {
            AnimatorAudioStateSetInspector.OnAnimatorAudioStateListRemove(list, m_CharacterItem.UnequipAnimatorAudioStateSet, SelectedUnequipAnimatorAudioStateSetIndexKey);
        }
        ...
        private void OnEquipAnimatorAudioStateSetStateListDraw(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            var animatorAudioState = m_CharacterItem.EquipAnimatorAudioStateSet.States[EditorPrefs.GetInt(SelectedEquipAnimatorAudioStateSetIndexKey)];
        ...
        {
            EditorGUI.BeginChangeCheck();
            var animatorAudioState = m_CharacterItem.UnequipAnimatorAudioStateSet.States[EditorPrefs.GetInt(SelectedUnequipAnimatorAudioStateSetIndexKey)];
