...
namespace Opsive.UltimateCharacterController.Demo.Objects
{
    ...
    public class Teleporter : MonoBehaviour
    {
        ...
        [SerializeField] protected string m_ActivateStateName;
        [Tooltip("The name of the state that should deactivate when the character teleports.")]
        [SerializeField] protected string m_DeactivateStateName;
#if UNITY_EDITOR
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            if ((characterLocomotion = other.GetComponentInParent<UltimateCharacterLocomotion>()) != null) {
                ...
                if (!string.IsNullOrEmpty(m_DeactivateStateName)) {
                    StateManager.SetState(characterLocomotion.gameObject, m_DeactivateStateName, false);
                }
                ...
                if (!string.IsNullOrEmpty(m_ActivateStateName)) {
                    StateManager.SetState(characterLocomotion.gameObject, m_ActivateStateName, true);
                }
            }
        }
