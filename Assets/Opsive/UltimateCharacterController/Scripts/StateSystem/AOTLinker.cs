...
#pragma warning disable 0219
            ...
            var minMaxFloatGenericDelegate = new Preset.GenericDelegate<Shared.Utility.MinMaxFloat>();
            var minMaxFloatFuncDelegate = new Func<Shared.Utility.MinMaxFloat>(() => { return new Shared.Utility.MinMaxFloat(); });
            var minMaxFloatActionDelegate = new Action<Shared.Utility.MinMaxFloat>((Shared.Utility.MinMaxFloat value) => { });
            ...
            var itemSubstateIndexDataGenericDelegate = new Preset.GenericDelegate<Items.Actions.ItemSubstateIndexData>();
            var itemSubstateIndexDataFuncDelegate = new Func<Items.Actions.ItemSubstateIndexData>(() => { return new Items.Actions.ItemSubstateIndexData(); });
            var itemSubstateIndexDataActionDelegate = new Action<Items.Actions.ItemSubstateIndexData>((Items.Actions.ItemSubstateIndexData value) => { });
            var itemSubstateIndexModuleDataGenericDelegate = new Preset.GenericDelegate<Items.Actions.ItemSubstateIndexModuleData>();
            var itemSubstateIndexModuleDataFlashFuncDelegate = new Func<Items.Actions.ItemSubstateIndexModuleData>(() => { return new Items.Actions.ItemSubstateIndexModuleData(); });
            var itemSubstateIndexModuleDataActionDelegate = new Action<Items.Actions.ItemSubstateIndexModuleData>((Items.Actions.ItemSubstateIndexModuleData value) => { });
            var itemSubstateIndexStreamDataGenericDelegate = new Preset.GenericDelegate<Items.Actions.ItemSubstateIndexStreamData>();
            var itemSubstateIndexStreamDataFlashFuncDelegate = new Func<Items.Actions.ItemSubstateIndexStreamData>(() => { return new Items.Actions.ItemSubstateIndexStreamData(); });
            var itemSubstateIndexStreamDataActionDelegate = new Action<Items.Actions.ItemSubstateIndexStreamData>((Items.Actions.ItemSubstateIndexStreamData value) => { });
