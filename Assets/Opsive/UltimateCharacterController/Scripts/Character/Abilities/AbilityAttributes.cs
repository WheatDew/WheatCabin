...
namespace Opsive.UltimateCharacterController.Character.Abilities
{
    ...
    /// <summary>
    /// Attribute which specifies the default Detect Ground Collisions for the ability.
    /// </summary>
    [AttributeUsage(AttributeTargets.Class, AllowMultiple = false, Inherited = false)]
    public class DefaultDetectGroundCollisions : Attribute
    {
        private Ability.AbilityBoolOverride m_Value;
        public Ability.AbilityBoolOverride Value { get { return m_Value; } }
        public DefaultDetectGroundCollisions(Ability.AbilityBoolOverride value) { m_Value = value; }
    }
    ...
    /// <summary>
    /// Attribute which specifies the default Detect Layers layermask for the ability.
    /// </summary>
    [AttributeUsage(AttributeTargets.Class, AllowMultiple = false, Inherited = false)]
    public class DefaultDetectLayers : Attribute
    {
        private int m_Value;
        public int Value { get { return m_Value; } }
        public DefaultDetectLayers(int value) { m_Value = value; }
    }
    ...
    /// <summary>
    /// Attribute which specifies the default Max Trigger Object Count for the ability.
    /// </summary>
    [AttributeUsage(AttributeTargets.Class, AllowMultiple = false, Inherited = false)]
    public class DefaultMaxTriggerObjectCount : Attribute
    {
        private int m_Value;
        public int Value { get { return m_Value; } }
        public DefaultMaxTriggerObjectCount(int value) { m_Value = value; }
    }
