    ...
    public class StopMovementAnimation : Ability
    {
        ...
        private bool PredicatedCollision()
        {
            ...
            if (m_CharacterLocomotion.SingleCast(direction, Vector3.zero, direction.magnitude, m_CharacterLayerManager.SolidObjectLayers, ref m_RaycastHit)) {
                ...
                var groundPoint = MathUtility.InverseTransformPoint(m_Rigidbody.position, m_Rigidbody.rotation, m_RaycastHit.point - m_CharacterLocomotion.MovingPlatformMovement);
