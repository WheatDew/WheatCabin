...
namespace Opsive.UltimateCharacterController.Items.AnimatorAudioStates
{
    ...
    public abstract class RecoilAnimatorAudioStateSelector : AnimatorAudioStateSelector
    {
        ...
        /// Default constructor.
        /// </summary>
        public RecoilAnimatorAudioStateSelector()
        {
            m_BlockedRecoilItemSubstateIndex = 20;
        }
        ...
        public RecoilAnimatorAudioStateSelector(int blockedRecoilItemSubstateIndex)
        {
            m_BlockedRecoilItemSubstateIndex = blockedRecoilItemSubstateIndex;
        }
        ...
        public virtual void NextState(int hitColliderCount, ListSlice<Collider> hitColliders, int useStateIndex)
        {
